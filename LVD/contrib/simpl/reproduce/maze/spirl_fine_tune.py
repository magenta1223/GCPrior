...
from simpl.env.maze import Size20Seed0Tasks, Size40Seed0Tasks

from .maze_vis import draw_maze


env = gym.make('simpl-maze-size20-seed0-v0')
tasks = Size20Seed0Tasks.modified_test_goals
# env = gym.make('simpl-maze-size40-seed0-v0')
# tasks = Size40Seed0Tasks.flat_test_tasks
