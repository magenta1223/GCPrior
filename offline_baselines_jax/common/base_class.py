...
class BaseAlgorithm(ABC):
    ...
    def set_parameters(
        ...
        objects_needing_update = set(self._get_jax_load_params())
        updated_objects = set()
    ...
    def load(
        ...
        **kwargs,
        ...
        data, params, pytorch_variables = load_from_zip_file(
            path, custom_objects=custom_objects, print_system_info=print_system_info
        )
    ...
    def get_parameters(self) -> Dict[str, Params]:
        ...
        """
        params_dict = self._get_jax_save_params()
        return params_dict
